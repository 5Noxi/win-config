...
LABEL_43
  ...
  v28 = a4;
  v14 = v36;
  v15 = RtlUnicodeStringPrintf(&DestinationString, L%S%S%S, v36, v35, v28); // "%S%S%S"
  v12 = 0;
  v13 = v15;
  if ( v15  0 )
  {
...
LABEL_13
    v17 = v31;
    LOBYTE(v12) = 2;
    WPP_RECORDER_SF_d(v31, v12, 5, v16, (__int64)&WPP_7a0afab5c79d3741c23ff4ee70090e0b_Traceguids, v15);
    v12 = 0;
LABEL_44
    a7 = 0;
    ...
    {
      LOBYTE(v12) = 2;
      WPP_RECORDER_SF_d(v17, v12, 5, 17, (__int64)&WPP_7a0afab5c79d3741c23ff4ee70090e0b_Traceguids, v13);
    }
    goto LABEL_49;
  }
  ...
  if ( v13 == -1073741772 )
  {
    ...
    v15 = RtlUnicodeStringPrintf(&DestinationString, L%S%S, v14, v35); // "%S%S"
    v12 = 0;
    v13 = v15;
    if ( v15  0 )
    {
...
LABEL_47
  ...
  {
    LOBYTE(v12) = 2;
    WPP_RECORDER_SF_d(v31, v12, 5, 18, (__int64)&WPP_7a0afab5c79d3741c23ff4ee70090e0b_Traceguids, a7);
  }
LABEL_49
  if ( v29 )
    ((void (__fastcall )(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1848))(WdfDriverGlobals);
