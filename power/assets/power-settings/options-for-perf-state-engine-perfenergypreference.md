...
`PerfEnergyPreference` specifies the value to program in the energy performance preference register on systems that implement version 2 of the CPPC interface and have autonomous mode [Enabled](options-for-perf-state-engine-perfautonomousmode).
